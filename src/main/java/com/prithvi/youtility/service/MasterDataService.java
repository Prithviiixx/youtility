...
import com.prithvi.youtility.model.MasterData;
    ...
    public MasterData fetchMasterData() {
        try {
            ...
            data.setEnergyRatings(List.of("A1","A2","A3","B1","B2","B3","C1","C2",
                    "C3","D1","D2","E1","E2","F","G"));
            data.setPropertyType(List.of("Electrical Wiring","Electricity Maintenance","Gas Pipeline Fitting",
                    "Gas Maintenance", "Steam Maintenance", "Air Conditioning Maintenance"));
        } catch (Exception ex) {
